  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        layout
        className={
          'hidden xs:flex flex-col absolute top-[120%] right-0 rounded-md shadow-2xl bg-[#fcfcfc] w-80 sm:w-96 min-h-80 z-50 overflow-y-auto max-h-[80vh]'
        }
        style={{
      ...
      >
        ...
        <div className='flex flex-col grow justify-center items-center'>
              ...
              return (
                ...
                >
                  <div className='h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200'>
                    <Link
                      to={`/productos/${item.producto.categoria}/${item.producto.id}`}
                    >
                      <img
          ...
          <div className='bg-[#fcfcfc] w-full'>
            ...
            >
              <button className='text-amber-900 font-bold hover:underline'>
                Ver carrito
              </button>
            </Link>
          </div>
