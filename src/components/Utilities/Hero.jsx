...
const cupones = [
  {
    id: 'cafeSemestre2022',
    descripcion:
      'Cupón de descuento del 20% en todos los productos de la categoría Café.',
  ...
  },
  {
    ...
    descripcion:
      'Cupón de descuento del 15% en todos los productos de la categoría Chocolate.',
    fechaInicio: '2022-01-01',
    fechaFin: '2022-12-31'
  },
  {
    ...
    <>
      <div className='flex flex-col index-page h-screen'>
        ...
        >
          ...
          <h1 className='text-5xl font-bold leading-normal text-gray-100'>
            {slogan}
          </h1>

          <Link className='w-max' to='/productos'>
            <motion.button
              animate={{
                scale: [1, 1.05, 1],
                rotate: [0, 5, -5, 0],
              ...
              className='text-xl bg-[#4a3933] [color:#ebecee] w-max my-4 rounded-lg font-bold p-2 hover:opacity-90'
            >
              Ver Productos
            </motion.button>
          </Link>
      ...
      <section>
        <h2 className='text-center text-3xl sm:text-3xl lg:text-4xl underline text-[#4a3933] font-bold mt-12 mb-6'>
          ¡Productos en oferta!
        </h2>
        <Cta />
      </section>
