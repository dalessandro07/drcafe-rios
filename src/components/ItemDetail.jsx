        ...
        <section className="text-gray-700 body-font overflow-hidden">
            <div className="container px-5 pt-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={producto.img} />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">DR CAFE</h2>
                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Café Etiopía</h1>
                        ...
                        <div className="flex">
                            <span className="title-font font-medium text-2xl text-gray-900">S/{producto.precio}</span>
